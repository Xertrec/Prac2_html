...
INSERT INTO serie (`nomSerie`, `anyCreacio`, `descripcio`, `imatge`, `valoracioMitjana`) VALUES 
('Friends', 1999, 'La història comença amb cinc amics (Chandler, Monica, Joey, Phoebe i Ross) conversant en una cafeteria i posteriorment el sisè (Rachel). 
...
un divorci i una filla anomenada Emma.', 'Practica1/../img/friends.jpg', 4.5),
...
VALUES
('Friends', '1', 'valorador1', '3', 'Comentari del valorador 1'),
('Friends', '1', 'valorador2', '2', 'Comentari del valorador 2'),
('Friends', '2', 'valorador1', '1', 'Comentari del valorador 1'),
('Friends', '2', 'valorador2', '3', 'Comentari del valorador 2'),
...
('Plats Bruts', '2', 'valorador2', '5', 'Comentari del valorado2'),
('Plats Bruts', '3', 'valorador1', '4', 'Comentari del valorado1'),
('Plats Bruts', '3', 'valorador2', '4', 'Comentari del valorado2');
